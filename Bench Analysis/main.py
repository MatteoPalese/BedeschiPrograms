...
{
	'Input Data': {
		'C2': [None, '-', None, 'Material'],
		'C3': [None, 'r [t/m3]', None, 'Bulk density'],
		'C4': [None, 'f [°]', None, 'Repose angle'],
		'C5': [None, 'materials[data["Input Data"]["C2"][0]'],
		'C6': [None, 'Q [t/h]', None, 'Nominal Required Capacity[0]'],
		'C7': [None, 'data["Input Data"]["C6"][0] / data["Input Data"]["C3"][0] / 3600'],
		'C8': [None, 'D [m]', None, 'Diameter (on cutting edge)'],
		'C9': [None, 'wBW [rpm]', None, 'Bucket wheel rotational speed'],
		'C10': [None, 'z', None, 'Number of buckets'],
		'C11': [None, 'Vb [m3] ', None, 'Bucket volume'],
		'C12': [None, 'tE [m]', None, 'Bucket height'],
		'C13': [None, 'bE [m]', None, 'Bucket width'],
		'C14': [None, '1.24 * pi / 4 * data["Input Data"]["C12"][0] ** 2 * data["Input Data"]["C13"][0]'],
		'C15': [None, 'θ [°]', None, 'Angle in which bucket discharge starts, measured from vert'],
		'C16': [None, 'm ', None, 'Efficiency of Drive (Coupling+Motor+Gearbox)'],
		'C17': [None, 'f', None, 'Bucket Efficiency (filling factor)'],
		...
		'C20': [None, 'Lb [m]', None, 'Boom Lenght'],
		'C21': [None, 'HL [m]', None, 'Height of boom hinge from bottom of yard'],
		'C22': [None, 'l [m]', None, 'Distance of boom hinge from slewing axle'],
		'C23': [None, 'h  [m]', None, 'Height of BW axle from boom hinge (with boom horizontal)'],
		'C24': [None, 'd [m]', None, 'Distance between pile CL and slewing axle'],
		'C25': [None, 'vSmax  [m/min]', None, 'Maximum selected boom slewing speed'],
		'C26': [None, 'Hp [m]', None, 'Stockpile height'],
		'C27': [None, 'Bp [m]', None, 'Bottom stockpile width'],
		'C28': [None, 'Lp [m]', None, 'Stockpile lenght (of the full stockpile section)'],
		...
		'C35': [None, 'ymax [°]', None, 'Selected Maximum angle of Reclaiming (in plant view)'],
		'C36': [None, 'a1 [°/s2]', None, 'Slewing acceleration[0]'],
		'C37': [None, 'data["Input Data"]["C36"][0] * pi / 180'],
		'C38': [None, 'a2 [°/s2]', None, 'Slewing deceleration[0]'],
		'C39': [None, 'data["Input Data"]["C38"][0] * pi / 180'],
		'C40': [None, 'data["Input Data"]["Stockpile height"] / data["Input Data"]["C8"][0] * 2'],
		'C41': [None, '-', None, 'Number of selected benches'],
		'C42': [None, 'data["Input Data"]["C12"][0] / cos(data["Input Data"]["C75"][0])'],
		'C43': [None, 'p [m]', None, 'Selected Step of Reclaiming[0]'],
		...
		'C84': [None, '0'],
		'C85': [None, 'data["Input Data"]["Angle between buckets"][0] if data["Input Data"]["C82"][0] >=2 else "n.a."'],
		'C86': [None, 'data["Input Data"]["Angle between buckets"][0] * 2 if data["Input Data"]["C82"][0] >=3 else "n.a."'],
		'C87': [None, 'data["Input Data"]["Angle between buckets"][0] * 3 if data["Input Data"]["C82"][0] >=4 else "n.a."'],
